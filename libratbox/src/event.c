 ...
 *  USA
 *
 *  $Id: event.c 27175 2011-03-28 18:27:10Z moggie $
 */
...
rb_event_update(struct ev_entry *ev, time_t freq)
{
	 ...
	 */
	if((rb_time() + freq) < ev->when)
		ev->when = rb_time() + freq;
	return;
}
