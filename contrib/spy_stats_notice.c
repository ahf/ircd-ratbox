 ...
 *  USA
 *
 *  $Id: spy_stats_notice.c 26377 2009-01-05 18:51:12Z androsyn $
 */
#include "stdinc.h"
...
mapi_hfn_list_av2 stats_hfnlist[] = {
	{"doing_stats", (hookfn) show_stats},
	{NULL, NULL}
};

DECLARE_MODULE_AV2(stats_spy, NULL, NULL, NULL, NULL, stats_hfnlist, "$Revision: 26377 $");
