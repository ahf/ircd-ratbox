 ...
 *
 *  $Id: bantool.c 27229 2011-10-13 05:51:10Z dubkat $
 *
 */
...
main(int argc, char *argv[])
{
	...
	fprintf(stdout,
		"* bantool v.%s built for %s ($Id: bantool.c 27229 2011-10-13 05:51:10Z dubkat $)\n",
...
print_help(int i_exit)
{
	...
	fprintf(stderr, "$Id: bantool.c 27229 2011-10-13 05:51:10Z dubkat $\n\n");
